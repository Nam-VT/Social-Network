...
public class PostController {
    ...
    public ResponseEntity<ApiResponse<PostResponse>> getPost(@PathVariable Long postId) {
        PostResponse data = postService.getPost(postId);
        return ResponseEntity.ok(ApiResponse.<PostResponse>builder()
    ...
    public ResponseEntity<ApiResponse<List<PostResponse>>> getUserPosts(@PathVariable String username) {
        List<PostResponse> data = postService.getUserPosts(username);
    ...
    public ResponseEntity<ApiResponse<List<PostResponse>>> getNewsFeed(
        ...
        List<PostResponse> data = postService.getNewsFeed(cursor, size);
        return ResponseEntity.ok(ApiResponse.<List<PostResponse>>builder()
                .status(ErrorCode.SUCCESS.getStatus())
                .message(ErrorCode.SUCCESS.getMessage())
                .data(data)
