...
export const ProfileHeader = ({ profile, isOwnProfile, onEditClick }: ProfileHeaderProps) => {
  ...
  return (
    <div className="bg-[var(--color-bg-secondary)] shadow-sm border border-[var(--color-border-light)] sm:rounded-b-xl overflow-hidden mb-4">
      ...
      {/* Profile Info Bar */}
      <div className="px-6 pb-6 pt-0 flex flex-col md:flex-row md:flex-wrap items-center md:items-end justify-between gap-6 relative -mt-16 sm:-mt-10">
        <div className="flex flex-col sm:flex-row items-center sm:items-end gap-4 sm:gap-6 z-10">
          ...
          {/* Name & Stats */}
          <div className="text-center sm:text-left pb-2 mt-2 sm:mt-0">
        ...
        {/* Actions */}
        <div className="flex flex-wrap items-center justify-center md:justify-end gap-3 pb-2 w-full md:w-auto md:ml-auto">
          {isOwnProfile ? (
            <button 
              className="flex items-center gap-2 px-4 py-2 bg-[var(--color-accent)] text-white rounded-md font-semibold text-sm hover:opacity-90 transition-colors"
              onClick={onEditClick}
